...
public class WebAPIDemoContext : DbContext
{
    ...
    private void SeedData(ModelBuilder modelBuilder)
    {
        ...
        // Postgres heeft een UTC datetime format nodig
        var utcDate = 

        modelBuilder.Entity<Klant>().HasData(
            new Klant { Id = 1, Naam = "Van Der Neffe", Voornaam = "Leon", AangemaaktDatum = DateTime.SpecifyKind(DateTime.Parse("2021-10-15T12:00:00"), DateTimeKind.Utc) },
            new Klant { Id = 2, Naam = "Van De Kasseinen", Voornaam = "Firmin", AangemaaktDatum = DateTime.SpecifyKind(DateTime.Parse("2014-10-15T12:00:00"), DateTimeKind.Utc) },
            new Klant { Id = 3, Naam = "Kiekeboe", Voornaam = "Marcel", AangemaaktDatum = DateTime.SpecifyKind(DateTime.Parse("2023-10-15T12:00:00"), DateTimeKind.Utc) }
        );
